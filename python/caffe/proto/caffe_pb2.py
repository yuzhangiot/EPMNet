...
_EPPMPARAMETER_EPPMTYPE = _descriptor.EnumDescriptor(
  name='EppmType',
  full_name='caffe.EppmParameter.EppmType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NO_SPATIAL', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_EPPMPARAMETER_EPPMTYPE)
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reshape_every_iter', full_name='caffe.LayerParameter.reshape_every_iter', index=70,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eppm_param', full_name='caffe.LayerParameter.eppm_param', index=71,
...
_EPPMPARAMETER = _descriptor.Descriptor(
  name='EppmParameter',
  full_name='caffe.EppmParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pad', full_name='caffe.EppmParameter.pad', index=0,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='kernel_size', full_name='caffe.EppmParameter.kernel_size', index=1,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_displacement', full_name='caffe.EppmParameter.max_displacement', index=2,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride_1', full_name='caffe.EppmParameter.stride_1', index=3,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stride_2', full_name='caffe.EppmParameter.stride_2', index=4,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='do_abs', full_name='caffe.EppmParameter.do_abs', index=5,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='eppm_type', full_name='caffe.EppmParameter.eppm_type', index=6,
      number=15, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['eppm_param'].message_type = _EPPMPARAMETER
...
_EPPMPARAMETER.fields_by_name['eppm_type'].enum_type = _EPPMPARAMETER_EPPMTYPE
_EPPMPARAMETER_EPPMTYPE.containing_type = _EPPMPARAMETER
...
DESCRIPTOR.message_types_by_name['EppmParameter'] = _EPPMPARAMETER
...
EppmParameter = _reflection.GeneratedProtocolMessageType('EppmParameter', (_message.Message,), dict(
  DESCRIPTOR = _EPPMPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.EppmParameter)
  ))
_sym_db.RegisterMessage(EppmParameter)
