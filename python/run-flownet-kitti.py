...
img_root = args.root + args.dataset + "/"
dirname = args.root + "results/" + args.dataset + "/"
fileNum = len([name for name in os.listdir(img_root)])
fileNum = fileNum / 2
print(img_root)
print(fileNum)
for idx in range(0,fileNum):
    img0_path = img_root + str(idx).zfill(6) + "_10.png"
    img1_path = img_root + str(idx).zfill(6) + "_11.png"

    out_path = args.root + "results/" + args.dataset + "/" + str(idx).zfill(6) + "_10.flo"
